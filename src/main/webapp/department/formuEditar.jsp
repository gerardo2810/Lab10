        ...
        <form method="POST" action="DepartmentServlet?action=actualizar" class="col-md-6 col-lg-6">
            ...
            <div class="mb-3">
                ...
                <select name="manager_id" class="form-select" id="manager_id">
                    ...
                    <option value="<%=manager!=null ? manager.getEmployeeId() : 0%>" <%=manager!=null && department.getManagerId()!=null && (manager.getEmployeeId() == department.getManagerId().getEmployeeId())?"selected":""%>  > <%=manager!=null? manager.getFullName(): ""%> </option>
                    <% } %>
                </select>
            </div>
            <div class="mb-3">
                ...
                <select name="location_id" class="form-select" id="location_id">
                    ...
                    <option value="<%=location.getLocationId()%>" <%=location.getLocationId() == department.getLocationId().getLocationId()?"selected":""%>   > <%=location.getCity()%>, <%=location.getStateProvince()%> </option>
                    <% } %>
                </select>
            </div>
